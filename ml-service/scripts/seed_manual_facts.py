...
_CITY_COUNCIL_CONTACTS_TEXT = (
    "Контакти Житомирської міської ради: адреса — Україна, 10014, м. Житомир, "
    "майдан ім. С. П. Корольова, 4/2. Телефони: (0412) 48-11-85 та (0412) 48-11-87. "
    "Графік роботи: понеділок-п'ятниця, 8:30-17:30, обідня перерва 12:30-13:30. "
    "Гаряча лінія міста: (0412) 481-481. Довідкова служба міста: 15-80. "
    "Офіційна сторінка: https://zt-rada.gov.ua/contacts."
)

_FOP_REGISTRATION_TEXT = (
    "Де зареєструвати ФОП у Житомирі: у відділі державної реєстрації юридичних осіб та "
    "фізичних осіб-підприємців департаменту реєстрації Житомирської міської ради за адресою "
    "вул. Бориса Лятошинського, 15-Б. Телефон: (0412) 42-01-82. Графік роботи: "
    "понеділок-п'ятниця, 8:30-17:30, обідня перерва 12:30-13:30; субота та неділя — вихідні. "
    "Онлайн ФОП можна зареєструвати через сервіс «е-Підприємець» на порталі «Дія». "
    "Офіційні сторінки: https://zt-rada.gov.ua/?departments=174 та "
    "https://zt-rada.gov.ua/?pages=18879. Перед візитом перевірте актуальність графіка."
)

_UTILITY_PAYMENT_TEXT = (
    ...
    "постачальника, особовий рахунок і реквізити перед оплатою. Перелік міських житлово-"
    "комунальних сервісів: https://zt-rada.gov.ua/?items=56. Якщо потрібна консультація щодо "
    "міського комунального питання, зателефонуйте на міську довідкову службу 15-80 або "
    "гарячу лінію (0412) 481-481."
    " Варіанти запиту: «як оплатити комуналку?», «как оплатить коммуналку?» та "
    "«как оплатить комуналку?»."
)
...
_DOCUMENTS = [
    ...
    ("manual-city-council-contacts-2026-07", _CITY_COUNCIL_CONTACTS_TEXT, "manual-curated"),
    ("manual-fop-registration-2026-07", _FOP_REGISTRATION_TEXT, "manual-curated"),
    ("manual-utility-payment-2026-07-v3", _UTILITY_PAYMENT_TEXT, "manual-curated"),
